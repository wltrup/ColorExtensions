...
extension UIColor {
    ...
    ///
    public static func randomDisplayP3A <RNG: RandomNumberGenerator> (using rng: inout RNG) -> UIColor 
    ...
    ///
    public static func randomRGBA <RNG: RandomNumberGenerator> (using rng: inout RNG) -> UIColor 
    ...
    ///
    public static func randomHSBA <RNG: RandomNumberGenerator> (using rng: inout RNG) -> UIColor 
    ...
    /// number generator.
    ///
    public static func randomWhiteAndAlpha <RNG: RandomNumberGenerator> (using rng: inout RNG) -> UIColor 
